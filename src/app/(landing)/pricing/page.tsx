...
const Page = () => {
    ...
    const INCLUDED_FEATURES = [
        "10.00 real-time events per month",
        "10 event categories",
        "Advanced anayltics and insignhts",
        "Priority support"
    ]
    ...
    return (
        <div className="bg-brand-25 py-24 sm:py-32">
            <MaxWidthWrapper>
                <div className="flex flex-col items-center mx-auto maw-w-2xl sm:text-center">
                    <Heading className="text-center">Simple no-tricks pricing</Heading>
                    <p className="mt-6 text-base/7 text-gray-600 max-w-prose text-center text-pretty">We hate subscriptions, so we offer one-time payment option.</p>
                </div>
                ...
                <div className="bg-white mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex  lg:max-w-none">
                    <div className="p-8 sm:p-10 lg:flex-auto">
                        ...
                        <p className="mt-6 text-base/7 text-gray-600">Invest once in ping panda and transform how u monitor your size forever. Never miss a beat in your business grow</p>
                    ...
                    <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                        <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                            <div className="mx-auto max-w-xs py-8">
                                ...
                                <Button onClick={handleGetAccess} className="mt-6 px-20">Get Ping-Panda</Button>
