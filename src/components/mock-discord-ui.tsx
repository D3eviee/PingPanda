...
import { Cog, Gift, Headphones, HelpCircle, Inbox, MenuIcon, Mic, Phone, Pin, PlusCircle, Search, Smile, Sticker, UserCircle, Video } from "lucide-react";
    ...
    return (
        <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
            ...
            <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
                ...
                <div  className="group mt-auto size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-discord-brand-color cursor-not-allowed">
            ...
            <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
                ...
                <div className="flex-1 overflow-y-auto pt-4">
                    ...
                    <div className="py-2 mb-4">
                        <h3 className="text-sm font-semibold text-[#839297] px-2 mb-2 uppercase">Direct Messages</h3>
                        <div className="flex items-center px-2 py-1.5 rounded bg-[#393243 text-white cursor-poiter]">
                            <Image src="/brand-asset-profile-picture.png" alt="Ping Panda Logo" width={32} height={32} className="object-cover rounded-full mr-3"/>
                ...
                <div className="p-2 bg-[#292b2f] flex items-center]">
                    ...
                    <div className="flex-1">
                        <p className="tex-sm font-medium text-white">You</p>
                        <p className="text-xs text-[#b9bbbe]">@your account</p>
                    </div>
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex items-center">
                            <div className="relative">
                                <Image src="/brand-asset-profile-picture.png" alt="Ping Panda Logo" width={40} height={40} className="object-cover rounded-full mr-3"/>
                ...
                <div className="p-4 ">
                    <div className="flex items-center bg-[#40444b] rounded-lg p-1">
                        ...
                        <input readOnly type="text" placeholder="Message @PingPanda" className="flex-1 bg-transparent py-2.5 px-1 text-white placeholder-[#72767d] focus:outline-none cursor-not-allowed"/>
