...
export const PaymentSuccessModal =  () => {
    ...
    return(
        <Modal showModal={isOpen} setShowModal={setIsOpen} onClose={handleClose} preventDefaultClose={!isPaymentSuccessful} className="px-6 pt-6 ">
            <div className="flex flex-col items-center">
                ...
                <div className="flex flex-col items-center justify-center h-64">
                    ...
                    <p className="text-sm/6 mt-2 text-center text-pretty text-gray-600">Processing your upgrade. May take a moment.</p>
                </div> : 
                <>
                    <div className="relative aspect-video border border-gray-200 w-full overflow-hidden rounded-lg bg-gray-50">
                        <img src={"/brand-asset-heart.png"} alt="Successful payment" className="h-full w-full object-cover"/>
                    </div>

                    <div className="mt-6 flex flex-col items-center gap-1 text-center">
                        <p className="text-lg/7 tracking-tight font-medium text-pretty">Upgrade Successful 🎊</p>
                        <p className="text-gray-600 text-sm/6 text-pretty">Thank you for upgrading to pro!</p>
                    </div>
